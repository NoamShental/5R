function read_unireads_save_split_to_regions(resDir,sample_name,primers_seq,max_err_inprimer,with_primer_flag,pe_flag,readsStatsObj)
...
load([resDir '/' sample_name '_unireads.mat'])
if isempty(Suni)
    frequni = [];
    readsuni = [];
    fwd_rvs_ind = [];
    for rr = 1:nR
        ...
        save([resDir '/sample_' sample_name '_region_' num2str(rr) '_unireads.mat'],'readsuni','frequni','fwd_rvs_ind');
    end
    return
end
