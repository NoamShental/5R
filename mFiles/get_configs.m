function [PrepConfig,AlgoConfig,DbFiles,primers_seq] = get_configs(db_dir, db_name, kmer_len)
...
db_suffix = ['unique_up_to_' num2str(maxNonACGT) '_ambiguous_16S'];


% Set the GG DB files
DbFiles.uniS16_dir = db_dir; %'/data1/fefuks/Green_Genes_201305/unique_up_to_3_ambiguous_16S';
DbFiles.file_prefix = [db_name '_' db_suffix]; %'GreenGenes_201305_unique_up_to_3_ambiguous_16S';
...
% Verify that the kmer_len for reconstruction is shorter than the DB_kmer_len
